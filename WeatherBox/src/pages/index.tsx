...
<div id="drawer-navigation" className="fixed top-0 left-0 z-40 w-64 h-screen p-4 overflow-y-auto transition-transform -translate-x-full bg-white dark:bg-gray-800" tabIndex={-1} aria-labelledby="drawer-navigation-label">
  ...
  <div className="py-4 overflow-y-auto">
      ...
      {/* <div>
        <div className="api">
          <div className="container">Search by Using a City Name (Example: Chicago) Or a Comma-Seperated City Name Along With The Country Code (Example: Chicago,US)
          </div>
        </div>
        <section className="top-banner">
          <div className="container">
            <img src="./apple-touch-icon.png"></img>
            <h1 className="heading">WeatherBox </h1>
            <form>
